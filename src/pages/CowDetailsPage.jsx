      ...
      try {
        ...
        alert(
          error.response?.data?.message ||
            "Failed to load cow details. Please check if the cow exists."
        );
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200 p-6 sm:p-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-6">
              ...
              ================================================== */}
              {cow.galleryImages &&
                cow.galleryImages.length > 0 && (
                  <div className="space-y-2">

                    <h3 className="font-serif text-sm text-[#0B3B2E] font-semibold">
                      Gallery Photos
                    </h3>
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-thin">
                      ...
                      {cow.coverImage && (
                        <div
                          onClick={() =>
                            setActiveImage(cow.coverImage)
                          }
                          className={`w-16 h-16 rounded-xl overflow-hidden cursor-pointer border-2 flex-shrink-0 transition ${
                            activeImage === cow.coverImage
                              ? "border-[#236B36] scale-105"
              ...
              {cow.video && (
                <div className="space-y-2">
                  ...
                  <h3 className="font-serif text-lg text-[#0B3B2E]">
                    Live Video Preview
                  </h3>
            ...
            <div className="flex flex-col justify-between">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6">
                  {cow.description ||
                    ...
                    "No detailed description provided for this cattle."}
                </p>
                ...
                <div className="space-y-2 mb-6 text-sm bg-gray-50 p-4 rounded-2xl border border-gray-200">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-[#0B3B2E] font-semibold">
                      {cow.healthStatus ||
                        "Healthy & Active"}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-[#0B3B2E] font-semibold">
                      {cow.feedType ||
                        "Natural Organic Feed & Green Fodder"}
                    </span>
                  </div>
              ...
              <button
                onClick={() =>
                  alert(
                    "Booking / Inquiry feature coming soon!"
                  )
                }
